...
var DexcomApiClient = function DexcomApiClient(_ref) {
  ...
  var loginAndTry = /*#__PURE__*/ (function () {
    var _ref3 = (0, _asyncToGenerator2['default'])(
      /*#__PURE__*/ _regenerator['default'].mark(function _callee2(func) {
        var response;
        return _regenerator['default'].wrap(
                                ...
                                switch ((_context3.prev = _context3.next)) {
                                  ...
                                  case 3:
                                    ...
                                    return _context3.abrupt(
                                      'return',
                                      response.data.map(_utils.transform)
                                    );
  ...
  var observe = /*#__PURE__*/ (function () {
    var _ref8 = (0, _asyncToGenerator2['default'])(
      /*#__PURE__*/ _regenerator['default'].mark(function _callee7(_ref7) {
        var _ref7$maxAttempts,
          maxAttempts,
          _ref7$delay,
          delay,
          listener,
            ...
            switch ((_context7.prev = _context7.next)) {
              case 0:
                (_ref7$maxAttempts = _ref7.maxAttempts),
                  (maxAttempts =
                    _ref7$maxAttempts === void 0 ? 50 : _ref7$maxAttempts),
                  (_ref7$delay = _ref7.delay),
                  (delay = _ref7$delay === void 0 ? 1000 : _ref7$delay),
              ...
              case 3:
                ...
                _yield$readLast2 = (0, _slicedToArray2['default'])(
                  _yield$readLast,
                  1
                );
                ...
                runPoints = ['0', '1', '2', '3', '4', '5'].reduce(function (
                  acc,
                  e
                ) {
